...
```
Payroll: €9,600,000 × 9.0% = €864,000
Assets:  €17,000,000 × 7.0% = €1,190,000
Total SBIE: €2,054,000
```

**Revised Excess Profit and Top-up Tax:**

```
Excess Profit = €19,250,000 − €2,054,000 = €17,196,000
Top-up Tax % = 15% − 11.95% = 3.05%
Top-up Tax = €17,196,000 × 3.05% = €524,478
```
